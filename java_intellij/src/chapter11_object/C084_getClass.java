...
/*
        ...
        xxx.class 파일에는 클래스, 인터페이스에 대한 변수, 메서드, 생성자 등의 정보가 있음
        Class 클래스는 컴파일된 xxx.class 파일에 저장된 클래스나 인터페이스의 정보를 가져오는데 사용
 */
        ...
        Class cls3;
        try {
            cls3 = Class.forName("chapter11_object.Human");
            System.out.println("cls3 : " + cls.getName());
