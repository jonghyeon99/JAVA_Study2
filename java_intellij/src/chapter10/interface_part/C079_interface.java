...
/*
    인터페이스 목적/이유
    - 자바의 다형성을 극대화하여 개발코드 수정을 줄이고 프로그램 유지보수성 향성
    - 공통점끼리만 하나로 묶어야 할 경우 상속관계가 아닌 것들도 다형적 변수에 의해 같은 타입으로 만들 수 있다.
    - 같은 타입으로 묶으므로써 매개변수의 다형성을 가질 수 있다.
    (JAVA8부터 default, static 메서드 추가)
 */
